- dashboard: 1_reach_overview
  ...
  - name: <font color="#34A853" size="45" weight="bold"><i class="fa fa-tachometer"
    ...
    body_text: "<center> <b>Recommended Action</b>\U0001f447 Drill into impressions\
      \ and cross device conversions to get an overview of campaign performance across\
      \ network and advertisers.<center>"
    row: 0
    col: 0
    width: 24
    height: 3
  ...
  - name: <font color="#34A853" size="45" weight="bold"><i class="fa fa-tachometer"
    ...
    title_text: <font color="#34A853" size="4.5" weight="bold"><i class="fa fa-tachometer"
      ...
      Campaigns, Advertisers & Sites </font>
    subtitle_text: ''
    body_text: "<center><b>Recommended Action</b>\U0001f447 Drill into campaigns to\
      \ gather a 360 view on our the campaign in performing. Take action by pausing\
      \ or optimising the spend on each campaign. </center>"
    row: 34
    col: 0
    width: 24
    height: 3
